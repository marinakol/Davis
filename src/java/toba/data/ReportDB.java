...
public class ReportDB {
    ...
    public static Workbook getUserEmail() {
        ...
        row.createCell(7).setCellValue("UserID");
        ...
        for (User u : users) {
            ...
            row.createCell(3).setCellValue(u.getAddress());
            row.createCell(4).setCellValue(u.getCity());
            row.createCell(5).setCellValue(u.getState());
            row.createCell(6).setCellValue(u.getZipcode());
            i++;
        }
    ...
    public static Workbook getDownloadDetail(
        ...
        // get the data from the database
        EntityManager em = DBUtil.getEmFactory().createEntityManager();
                "WHERE d.downloadDate >= :startD        String qString = \"SELECT d from Download d \" +\n" +
"ate AND " +
